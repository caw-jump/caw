...
const CORE_PAGES = [
  ...
  ['blog', 'Blog | Chris Amaya', [['hero', { badge: 'BLOG', headline: 'Blog', subhead: 'Technical insights on architecture, automation, and scaling agencies.', cta_label: 'Read Latest', cta_href: '#posts' }], ['value_prop', { title: 'Coming Soon', body: 'Articles on PostgreSQL, FastAPI, Astro, and sovereign infrastructure. Check back soon.' }], ['cta', { heading: 'Get Technical Insights', text: 'Book a strategy session for tailored advice.', label: 'Book a Call', href: '/contact' }]]],
  ['search', 'Search | Chris Amaya', [['hero', { badge: 'SEARCH', headline: 'Search', subhead: 'Find content across chrisamaya.work.', cta_label: 'Home', cta_href: '/' }], ['value_prop', { title: 'Site Search', body: 'Full-text search coming soon. In the meantime, use the nav or <a href="/guide/how-i-build">How I Build</a>, <a href="/services">Services</a>, and <a href="/resources/calculators">Calculators</a>.' }], ['cta', { heading: "Need Something Specific?", text: "Describe what you're looking for and we can point you there.", label: 'Get in Touch', href: '/contact' }]]],
  ['knowledge-base', 'Knowledge Base | Chris Amaya', [['hero', { badge: 'KB', headline: 'Knowledge Base', subhead: 'Guides, FAQs, and technical references.', cta_label: 'How I Build', cta_href: '/guide/how-i-build' }], ['value_prop', { title: 'Growing Collection', body: 'Documentation on architecture patterns, API design, and deployment. Start with <a href="/guide/how-i-build">How I Build</a> or explore <a href="/services">Services</a>.' }], ['cta', { heading: "Can't Find What You Need?", text: 'Ask directly. I answer technical questions.', label: 'Book a Call', href: '/contact' }]]],
  ['pricing', 'Pricing | Chris Amaya', [['hero', { badge: 'INVESTMENT', headline: 'Transparent About Investment.', subhead: 'No hourly games. Scope-based. Typical engagements fit serious agencies and growing teams.', cta_label: 'Get a Ballpark', cta_href: '/contact' }], ['value_prop', { title: 'How Pricing Works', body: '<p>Investment depends on scope: what we\'re building, how many integrations, and whether it\'s net-new or extending an existing system. Most projects fall in a range that reflects 2–4 weeks of focused architecture and build.</p><p>Minimum engagement ensures we\'re solving real problems, not band-aids. I don\'t do tiny one-off fixes; I do systems that scale.</p><p>Book a <a href="/contact">strategy session</a> and I\'ll give you a ballpark — no commitment.</p>' }], ['cta', { heading: 'Get a Ballpark', text: 'One conversation. No pitch. Real numbers.', label: 'Book a Strategy Call', href: '/contact' }]]],
];
